class QuestionAnswersController < ApplicationController
  ...
  def destroy
    QuestionAnswer.find_by(id: params[:id],question_id: params[:question_id]).destroy
    redirect_to ("/questions/#{params[:question_id]}"), notice: "コメントを解除しました。", status: :see_other
  end
